...
对于子图$G_1$和$G_2$的Laplacian矩阵$L_1$和$L_2$, 均有$L_i I_i=bold(0)$, 并且显然$L_i bold(0)=bold(0)$, 故满足
$ (chi_(G_k))_i = cases(
  1 quad i in G_k,0 quad "otherwise"
) $的$chi_(G_1), chi_(G_2)$均是特征向量, 都对应0特征值. 

== 4.4.b

实验见4.4.b.jl, 可以明显发现, 当往图中两个子图之间逐渐添加越来越多的边, Fiedler向量对应的特征值逐渐变大.
#table(
  columns: (auto, auto),
  align: (right, right),
  [*$m$*], [*$lambda_2$*],
