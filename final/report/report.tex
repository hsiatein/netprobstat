...
本项目的分析主要包括网络的基本统计特性、关键节点的识别、社区结构的发现以及网络整体的拓扑性质。通过这些分析，本项目旨在揭示该社交网络中的信息传播模式、影响力分布和用户群体的组织方式。
...
\subsubsection{紧密中心性}
紧密中心性衡量一个节点到网络中所有其他节点的平均距离的倒数。值越高，表明该节点越容易“接触”到网络中的其他所有节点。由于原图不连通，本项目在最大的连通分量上计算了该指标。
\begin{table}[htbp]
    \centering
...
\subsection{社区检测}
社区检测旨在发现网络中连接紧密的节点群组，这些群组内部的连接远多于其与网络其余部分的连接。本项目使用了高效的Leiden算法。
\begin{itemize}
...
\section{总结}
通过本次分析，本项目揭示了“希格斯玻色子”提及网络是一个典型的无标度社交网络。网络规模庞大但结构松散，存在一个核心的“巨型连通分量”和大量外围小社群。
